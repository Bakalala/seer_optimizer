...
// SystemVerilog created from gemm_k8_latency_under_lut_i_iord_bl_call00008_latency_under_lut0
...
module gemm_k8_latency_under_lut_i_iord_bl_call00008_latency_under_lut0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_gemm_k8_latency_under_lut_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_gemm_k8_latency_under_lut_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_gemm_k8_latency_under_lut_i_fifodata),
    ...
    assign out_iord_bl_call_gemm_k8_latency_under_lut_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,42)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,44)
    assign out_iord_bl_call_gemm_k8_latency_under_lut_o_fifoready = iord_o_fifoready;
