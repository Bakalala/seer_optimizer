...
// SystemVerilog created from dot16_power_unconstrained_i_iord_bl_call0000power_unconstrained0
...
module dot16_power_unconstrained_i_iord_bl_call0000power_unconstrained0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_dot16_power_unconstrained_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_dot16_power_unconstrained_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_dot16_power_unconstrained_i_fifodata),
    ...
    assign out_iord_bl_call_dot16_power_unconstrained_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,74)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,76)
    assign out_iord_bl_call_dot16_power_unconstrained_o_fifoready = iord_o_fifoready;
