...
// SystemVerilog created from fir8_power_unconstrained_i_llvm_fpga_pipeline_keep_going_1_sr
...
module fir8_power_unconstrained_i_llvm_fpga_pipeline_keep_going_1_sr (
