...
// SystemVerilog created from dot16_latency_unconstrained_i_iord_bl_ca0000tency_unconstrained0
...
module dot16_latency_unconstrained_i_iord_bl_ca0000tency_unconstrained0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_dot16_latency_unconstrained_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_dot16_latency_unconstrained_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_dot16_latency_unconstrained_i_fifodata),
    ...
    assign out_iord_bl_call_dot16_latency_unconstrained_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,74)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,76)
    assign out_iord_bl_call_dot16_latency_unconstrained_o_fifoready = iord_o_fifoready;

    // ip_dsdk_adapt_bitselect64(BITSELECT,36)
    assign ip_dsdk_adapt_bitselect64_b = iord_o_data[1023:992];

    // ip_dsdk_adapt_bitselect62(BITSELECT,35)
    assign ip_dsdk_adapt_bitselect62_b = iord_o_data[991:960];

    // ip_dsdk_adapt_bitselect60(BITSELECT,34)
    assign ip_dsdk_adapt_bitselect60_b = iord_o_data[959:928];

    // ip_dsdk_adapt_bitselect58(BITSELECT,32)
    assign ip_dsdk_adapt_bitselect58_b = iord_o_data[927:896];

    // ip_dsdk_adapt_bitselect56(BITSELECT,31)
    assign ip_dsdk_adapt_bitselect56_b = iord_o_data[895:864];

    // ip_dsdk_adapt_bitselect54(BITSELECT,30)
    assign ip_dsdk_adapt_bitselect54_b = iord_o_data[863:832];

    // ip_dsdk_adapt_bitselect52(BITSELECT,29)
    assign ip_dsdk_adapt_bitselect52_b = iord_o_data[831:800];

    // ip_dsdk_adapt_bitselect50(BITSELECT,28)
    assign ip_dsdk_adapt_bitselect50_b = iord_o_data[799:768];

    // ip_dsdk_adapt_bitselect48(BITSELECT,27)
    assign ip_dsdk_adapt_bitselect48_b = iord_o_data[767:736];

    // ip_dsdk_adapt_bitselect46(BITSELECT,26)
    assign ip_dsdk_adapt_bitselect46_b = iord_o_data[735:704];

    // ip_dsdk_adapt_bitselect44(BITSELECT,25)
    assign ip_dsdk_adapt_bitselect44_b = iord_o_data[703:672];

    // ip_dsdk_adapt_bitselect42(BITSELECT,24)
    assign ip_dsdk_adapt_bitselect42_b = iord_o_data[671:640];

    // ip_dsdk_adapt_bitselect40(BITSELECT,23)
    assign ip_dsdk_adapt_bitselect40_b = iord_o_data[639:608];

    // ip_dsdk_adapt_bitselect38(BITSELECT,21)
    assign ip_dsdk_adapt_bitselect38_b = iord_o_data[607:576];

    // ip_dsdk_adapt_bitselect36(BITSELECT,20)
    assign ip_dsdk_adapt_bitselect36_b = iord_o_data[575:544];

    // ip_dsdk_adapt_bitselect34(BITSELECT,19)
    assign ip_dsdk_adapt_bitselect34_b = iord_o_data[543:512];

    // ip_dsdk_adapt_bitselect32(BITSELECT,18)
    assign ip_dsdk_adapt_bitselect32_b = iord_o_data[511:480];

    // ip_dsdk_adapt_bitselect30(BITSELECT,17)
    assign ip_dsdk_adapt_bitselect30_b = iord_o_data[479:448];

    // ip_dsdk_adapt_bitselect28(BITSELECT,16)
    assign ip_dsdk_adapt_bitselect28_b = iord_o_data[447:416];

    // ip_dsdk_adapt_bitselect26(BITSELECT,15)
    assign ip_dsdk_adapt_bitselect26_b = iord_o_data[415:384];

    // ip_dsdk_adapt_bitselect24(BITSELECT,14)
    assign ip_dsdk_adapt_bitselect24_b = iord_o_data[383:352];

    // ip_dsdk_adapt_bitselect22(BITSELECT,13)
    assign ip_dsdk_adapt_bitselect22_b = iord_o_data[351:320];

    // ip_dsdk_adapt_bitselect20(BITSELECT,12)
    assign ip_dsdk_adapt_bitselect20_b = iord_o_data[319:288];

    // ip_dsdk_adapt_bitselect18(BITSELECT,10)
    assign ip_dsdk_adapt_bitselect18_b = iord_o_data[287:256];

    // ip_dsdk_adapt_bitselect16(BITSELECT,9)
    ...
    // ip_dsdk_adapt_bitselect8(BITSELECT,37)
    assign ip_dsdk_adapt_bitselect8_b = iord_o_data[127:96];

    // ip_dsdk_adapt_bitselect6(BITSELECT,33)
    assign ip_dsdk_adapt_bitselect6_b = iord_o_data[95:64];

    // ip_dsdk_adapt_bitselect4(BITSELECT,22)
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,77)@1
