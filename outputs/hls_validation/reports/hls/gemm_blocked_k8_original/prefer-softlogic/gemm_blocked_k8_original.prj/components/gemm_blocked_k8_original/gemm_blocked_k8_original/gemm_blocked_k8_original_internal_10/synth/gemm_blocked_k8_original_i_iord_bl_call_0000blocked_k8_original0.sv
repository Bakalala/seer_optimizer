...
// SystemVerilog created from gemm_blocked_k8_original_i_iord_bl_call_0000blocked_k8_original0
...
module gemm_blocked_k8_original_i_iord_bl_call_0000blocked_k8_original0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_gemm_blocked_k8_original_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_gemm_blocked_k8_original_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_gemm_blocked_k8_original_i_fifodata),
    ...
    assign out_iord_bl_call_gemm_blocked_k8_original_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,42)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,44)
    assign out_iord_bl_call_gemm_blocked_k8_original_o_fifoready = iord_o_fifoready;
