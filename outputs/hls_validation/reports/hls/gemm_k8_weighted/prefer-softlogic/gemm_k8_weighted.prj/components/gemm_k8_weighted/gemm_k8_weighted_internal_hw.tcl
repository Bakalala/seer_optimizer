...
set_module_property NAME gemm_k8_weighted_internal
set_module_property VERSION 1.0
set_module_property INTERNAL true
set_module_property GROUP HLS
set_module_property DISPLAY_NAME gemm_k8_weighted_internal
set_module_property INSTANTIATE_IN_SYSTEM_MODULE true
set_module_property EDITABLE true
set_module_property SUPPORTED_DEVICE_FAMILIES {"Arria 10"}
set_module_assignment hls.cosim.name {gemm_k8_weighted}
set_module_assignment hls.compressed.name {gemm_k8_weighted}

#### Synthesis fileset
add_fileset QUARTUS_SYNTH QUARTUS_SYNTH "" ""
set_fileset_property QUARTUS_SYNTH TOP_LEVEL gemm_k8_weighted_internal
...
add_fileset_file "gemm_k8_weighted_function_wrapper.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_function_wrapper.sv"
add_fileset_file "gemm_k8_weighted_function.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_function.sv"
add_fileset_file "gemm_k8_weighted_bb_B0_runOnce.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_bb_B0_runOnce.sv"
add_fileset_file "gemm_k8_weighted_bb_B0_runOnce_stall_region.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_bb_B0_runOnce_stall_region.sv"
add_fileset_file "gemm_k8_weighted_B0_runOnce_merge_reg.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_B0_runOnce_merge_reg.sv"
add_fileset_file "gemm_k8_weighted_i_llvm_fpga_pop_token_i1_wt_limpop_0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_llvm_fpga_pop_token_i1_wt_limpop_0.sv"
add_fileset_file "gemm_k8_weighted_i_llvm_fpga_pop_token_i1_wt_limpop_0_reg.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_llvm_fpga_pop_token_i1_wt_limpop_0_reg.sv"
add_fileset_file "gemm_k8_weighted_i_llvm_fpga_push_token_i1_wt_limpush_0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_llvm_fpga_push_token_i1_wt_limpush_0.sv"
add_fileset_file "gemm_k8_weighted_i_llvm_fpga_push_token_i1_wt_limpush_1_reg.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_llvm_fpga_push_token_i1_wt_limpush_1_reg.sv"
add_fileset_file "gemm_k8_weighted_B0_runOnce_branch.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_B0_runOnce_branch.sv"
add_fileset_file "gemm_k8_weighted_B0_runOnce_merge.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_B0_runOnce_merge.sv"
add_fileset_file "gemm_k8_weighted_bb_B1_start.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_bb_B1_start.sv"
add_fileset_file "gemm_k8_weighted_bb_B1_start_stall_region.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_bb_B1_start_stall_region.sv"
add_fileset_file "gemm_k8_weighted_B1_start_merge_reg.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_B1_start_merge_reg.sv"
add_fileset_file "gemm_k8_weighted_i_iowr_bl_return_unname0000d3_gemm_k8_weighted0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_iowr_bl_return_unname0000d3_gemm_k8_weighted0.sv"
add_fileset_file "gemm_k8_weighted_i_iord_bl_call_unnamed_0000d2_gemm_k8_weighted0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_iord_bl_call_unnamed_0000d2_gemm_k8_weighted0.sv"
add_fileset_file "gemm_k8_weighted_i_sfc_s_c0_in_wt_entry_0000r1_gemm_k8_weighted0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_sfc_s_c0_in_wt_entry_0000r1_gemm_k8_weighted0.sv"
add_fileset_file "gemm_k8_weighted_i_llvm_fpga_sfc_exit_s_0000it_gemm_k8_weighted0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_llvm_fpga_sfc_exit_s_0000it_gemm_k8_weighted0.sv"
add_fileset_file "gemm_k8_weighted_i_sfc_logic_s_c0_in_wt_0000r1_gemm_k8_weighted0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_sfc_logic_s_c0_in_wt_0000r1_gemm_k8_weighted0.sv"
add_fileset_file "gemm_k8_weighted_i_llvm_fpga_pipeline_keep_going_0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_llvm_fpga_pipeline_keep_going_0.sv"
add_fileset_file "gemm_k8_weighted_i_llvm_fpga_push_i1_notexitcond_0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_llvm_fpga_push_i1_notexitcond_0.sv"
add_fileset_file "gemm_k8_weighted_i_sfc_s_c1_in_wt_entry_0000er_gemm_k8_weighted3.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_sfc_s_c1_in_wt_entry_0000er_gemm_k8_weighted3.sv"
add_fileset_file "gemm_k8_weighted_i_llvm_fpga_sfc_exit_s_0001it_gemm_k8_weighted0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_llvm_fpga_sfc_exit_s_0001it_gemm_k8_weighted0.sv"
add_fileset_file "gemm_k8_weighted_i_sfc_logic_s_c1_in_wt_0000er_gemm_k8_weighted0.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_sfc_logic_s_c1_in_wt_0000er_gemm_k8_weighted0.sv"
add_fileset_file "gemm_k8_weighted_B1_start_branch.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_B1_start_branch.sv"
add_fileset_file "gemm_k8_weighted_B1_start_merge.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_B1_start_merge.sv"
add_fileset_file "gemm_k8_weighted_i_llvm_fpga_pipeline_keep_going_1_sr.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_llvm_fpga_pipeline_keep_going_1_sr.sv"
add_fileset_file "gemm_k8_weighted_i_llvm_fpga_pipeline_keep_going_1_valid_fifo.sv" SYSTEM_VERILOG PATH "ip/gemm_k8_weighted_i_llvm_fpga_pipeline_keep_going_1_valid_fifo.sv"
add_fileset_file "gemm_k8_weighted_internal.v" SYSTEM_VERILOG PATH "gemm_k8_weighted_internal.v"

#### Simulation fileset
add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL gemm_k8_weighted_internal
