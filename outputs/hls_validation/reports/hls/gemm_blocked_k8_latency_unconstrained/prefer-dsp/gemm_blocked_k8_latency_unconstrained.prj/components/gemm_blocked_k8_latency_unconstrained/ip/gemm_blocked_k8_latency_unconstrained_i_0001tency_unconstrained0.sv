...
// SystemVerilog created from gemm_blocked_k8_latency_unconstrained_i_0001tency_unconstrained0
...
module gemm_blocked_k8_latency_unconstrained_i_0001tency_unconstrained0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_gemm_blocked_k8_latency_unconstrained_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_gemm_blocked_k8_latency_unconstrained_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_gemm_blocked_k8_latency_unconstrained_i_fifodata),
    ...
    assign out_iord_bl_call_gemm_blocked_k8_latency_unconstrained_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,42)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,44)
    assign out_iord_bl_call_gemm_blocked_k8_latency_unconstrained_o_fifoready = iord_o_fifoready;
    ...
    // ip_dsdk_adapt_bitselect8(BITSELECT,21)
    assign ip_dsdk_adapt_bitselect8_b = iord_o_data[127:96];

    // ip_dsdk_adapt_bitselect6(BITSELECT,20)
    assign ip_dsdk_adapt_bitselect6_b = iord_o_data[95:64];

    // ip_dsdk_adapt_bitselect4(BITSELECT,19)
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,45)@1
