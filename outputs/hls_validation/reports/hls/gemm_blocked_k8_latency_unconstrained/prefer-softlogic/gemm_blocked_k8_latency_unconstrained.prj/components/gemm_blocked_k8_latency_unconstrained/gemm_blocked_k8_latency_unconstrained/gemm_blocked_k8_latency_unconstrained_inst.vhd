	component gemm_blocked_k8_latency_unconstrained is
		port (
	...
	end component gemm_blocked_k8_latency_unconstrained;

	u0 : component gemm_blocked_k8_latency_unconstrained
		port map (
