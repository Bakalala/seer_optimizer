...
// SystemVerilog created from fir8_latency_under_dsp_i_iowr_bl_return_00008_latency_under_dsp0
...
module fir8_latency_under_dsp_i_iowr_bl_return_00008_latency_under_dsp0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_fir8_latency_under_dsp_i_fifoready;
    ...
    assign out_iowr_bl_return_fir8_latency_under_dsp_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,9)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iowr_bl_return_fir8_latency_under_dsp_o_fifovalid = iowr_o_fifovalid;
