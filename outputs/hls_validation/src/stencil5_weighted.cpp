...
extern "C" HLS_COMPONENT hls_word_t stencil5_weighted(hls_word_t in_center, hls_word_t in_east, hls_word_t in_north, hls_word_t in_south, hls_word_t in_west) {
