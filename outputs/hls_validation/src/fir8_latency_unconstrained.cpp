...
// analytical metrics: area=38 latency=9 power=31 dsp=10 lut=10
// expression: ((((3 *lut x5) +dsp ((4 *dsp x4) +dsp ((4 *dsp x3) +dsp ((3 *dsp x2) +dsp ((x1 +lut x1) +dsp x0))))) +dsp (x6 +lut x6)) +dsp x7)

extern "C" HLS_COMPONENT hls_word_t fir8_latency_unconstrained(hls_word_t in_x0, hls_word_t in_x1, hls_word_t in_x2, hls_word_t in_x3, hls_word_t in_x4, hls_word_t in_x5, hls_word_t in_x6, hls_word_t in_x7) {
