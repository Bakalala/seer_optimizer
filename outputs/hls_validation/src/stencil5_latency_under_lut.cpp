...
// analytical metrics: area=38 latency=7 power=23 dsp=9 lut=0
// expression: ((-1 *dsp west) +dsp ((-1 *dsp east) +dsp ((-1 *dsp south) +dsp ((-1 *dsp north) +dsp (4 *dsp center)))))

extern "C" HLS_COMPONENT hls_word_t stencil5_latency_under_lut(hls_word_t in_center, hls_word_t in_east, hls_word_t in_north, hls_word_t in_south, hls_word_t in_west) {
