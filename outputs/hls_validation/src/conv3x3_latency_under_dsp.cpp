...
// analytical metrics: area=16 latency=18 power=18 dsp=0 lut=20
// expression: ((((((4 *lut p11) +lut ((((p01 +lut p01) +lut p00) +lut p02) +lut (p10 +lut p10))) +lut (p12 +lut p12)) +lut p20) +lut (p21 +lut p21)) +lut p22)

extern "C" HLS_COMPONENT hls_word_t conv3x3_latency_under_dsp(hls_word_t in_p00, hls_word_t in_p01, hls_word_t in_p02, hls_word_t in_p10, hls_word_t in_p11, hls_word_t in_p12, hls_word_t in_p20, hls_word_t in_p21, hls_word_t in_p22) {
