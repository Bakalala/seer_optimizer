...
The evaluation follows those contributions by asking whether weighted extraction is sufficient, whether constraints select different points, whether hard budgets expose infeasible regions, and whether generated RTL preserves behavior while steering fitted resources. The core claim is straightforward: for SEER-style equality saturation in HLS, generating equivalent implementations is not enough.
